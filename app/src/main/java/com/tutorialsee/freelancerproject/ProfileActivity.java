...
public class ProfileActivity extends Activity {
	Context context;
	ImageView back,editprofile,changepasword;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		changepasword  = (ImageView) findViewById(R.id.changepasword);
		editprofile.setOnClickListener(new OnClickListener() {
			
			@Override
			public void onClick(View arg0) {
				Intent ii=new Intent(getApplicationContext(),EditProfile.class);
		...
		changepasword.setOnClickListener(new OnClickListener() {
